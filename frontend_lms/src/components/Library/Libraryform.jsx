     ...
     <div className="container p-1">
        <div className="row justify-content-center">
          <div className="col-10 col-sm-8 col-md-6">
            <h2 className="heading text-center mt-4 bg-dark text-white py-1 px-3 mx-auto rounded shadow-lg" style={{ maxWidth: '400px' }}>Library Card Form</h2>
          </div>
        </div>
                    ...
                    <div className="card-body">
                        <form className='form'>
                            ...
                            <div className="row mb-3 g-2 mt-3">
                                ...
                                <div className="col-12 col-md-6">
                                    <input type="text" className="form-control" id="religiousid" placeholder="Religious" required />
                                </div>
                            </div>
                            <div className="row mb-3 g-2 mt-3">
                                <div className="col-12 col-md-6">
