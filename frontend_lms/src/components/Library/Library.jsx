                            ...
                            <div className="col-md-5 d-flex justify-content-center align-items-center p-3">
                                <div className="card  bg-light border-0" >
                                    <div className="card-body">
                                        <h5 className="card-title text-danger fw-bold fs-3">Welcome to Our Library</h5>
                                    ...
                                    <div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel">
                                        ...
                                        <div className="carousel-inner">
                                            <div className="carousel-item active">
                                                <img src="/library.jpg" className="d-block w-100 image-fluid rounded" alt=" " style={{ height: "440px", filter: "brightness(0.8)" }} />
                                            </div>
                                            <div className="carousel-item">
                                                <img src="/library2.jpg" className="d-block w-100 image-fluid rounded" alt=" " style={{ height: "440px", filter: "brightness(0.8)" }} />
                                            </div>
                                            <div className="carousel-item">
                                                <img src="/library3.jpg" className="d-block w-100 image-fluid rounded" alt=" " style={{ height: "440px", filter: "brightness(0.8)" }} />
                                            </div>
                                        </div>
