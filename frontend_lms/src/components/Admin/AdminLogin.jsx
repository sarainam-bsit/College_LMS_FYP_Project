  ...
  return (
    <>
      <style>{`
        ...
        .login-card h3 { text-align: center; margin-bottom: 20px; background: rgb(2,2,40); 
          padding: 10px; border-radius: 12px; }
        .LoginInput { background: rgba(255,255,255,0.2); border: none; color: white; }
        .LoginInput::placeholder { color: #ddd; }
        .LoginBtn { width: 100%; margin-top: 15px; color: white; font-size: 1.3rem; 
          font-weight: bold; background: rgb(2,2,40); border: none; }
        ...
        <div className="login-overlay">
          <div className="login-card">
            <form onSubmit={handleLogin}>
              ...
              <button type="submit" className="LoginBtn btn btn-white">Login</button>
              <div className="mt-3">
                <p>
                  <Link className="text-decoration-none text-white" to="/adminreset">
                    Forget Password?
                  </Link>
                </p>
              </div>
