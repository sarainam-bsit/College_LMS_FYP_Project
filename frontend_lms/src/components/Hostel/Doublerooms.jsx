              ...
              <div className="card mb-3  border-0">
                <div className="row g-0 flex-column flex-md-row">
                  ...
                  <div className="col-md-7 p-4">
                    <h2 className='text-danger'><i class="fa-solid fa-house"></i> <b>Double Room Facilities</b></h2>
                    <ul class="list-group list-group-flush">
                      <li class="list-group-item"><i class="fa-solid fa-bed"></i> One Shared Double Bed for 2 Persons</li>
                      <li class="list-group-item"><i class="fa-solid fa-book"></i> One Study Table & Two Chairs</li>
                      <li class="list-group-item"><i class="fa-solid fa-box"></i> One shared Cupboard</li>
