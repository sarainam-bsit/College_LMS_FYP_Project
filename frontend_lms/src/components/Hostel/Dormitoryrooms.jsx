                            ...
                            <div className="card mb-3  border-0">
                                <div className="row g-0 flex-column flex-md-row">
                                    ...
                                    <div className="col-md-7 p-4">
                                        <h2 className='text-danger'><i class="fa-solid fa-house"></i> <b>Dormitory Rooms Facilities</b></h2>
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item"><i class="fa-solid fa-bed"></i> Mutiple Beds in a single room </li>
                                            <li class="list-group-item"><i class="fa-solid fa-box"></i> Shared Cupboards/Lockers</li>
                                            <li class="list-group-item"><i class="fa-solid fa-bath"></i> Attached & Shared Bathroom</li>
                                            <li class="list-group-item"><i class="fa-solid fa-lightbulb"></i> Fan & Lights</li>
                                            <li class="list-group-item"><i class="fa-solid fa-person-booth"></i>  Curtains or Partitions for Privacy</li>
                                            ...
                                            <li class="list-group-item"><i class="fa-solid fa-trash"></i> Two Dustbin for a whole room</li>
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <Link to="/hosteladmissionform" class="btn btn-danger btn-lg mb-3 me-md-2 px-5 " type="button">Online Apply</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
