...
const Hostelcancelform = () => {
  return (
    <div className="container p-1">
        <div className="row justify-content-center">
          <div className="col-10 col-sm-8 col-md-6">
            <h2 className="heading text-center mt-4 bg-dark text-white py-1 px-3 mx-auto rounded shadow-lg" style={{ maxWidth: '400px' }}>Hostel Cancellation Form</h2>
          </div>
        </div>
                        ...
                        <form className='form'>
                            ...
                            <div className="row mb-3 g-2 mt-3">
                                ...
                                <div className="col-12 col-md-6">
                                    <label className="visually-hidden" for="autoSizingSelect">Preference</label>
                                    <select className="form-select" id="autoSizingSelect" required>
                                        <option value="1">Cancel Room Type</option>
                            ...
                            <div className="row mb-3 g-2 mt-3">
                                <div className="col-12 col-md-6">
                                    <input type="number" className="form-control" id="roomNo" name="roomNo" placeholder="Room No"  required />
                                </div>
                                <div className="col-12 col-md-6">
                            ...
                            <div className="row mb-3 g-2 mt-3">
                                <div className="col-12 col-md-6">
                                    <input type="date" className="form-control" id="dateforcancellation" name="dateforcancellation" placeholder="Date For Cancellation"  required />
                                </div>
                                <div className="col-12 col-md-6">
                                    <input type="date" className="form-control" id="lastdate" name="lastdate" placeholder="Last Date Of Occupacy"  required />
                                </div>
                               
                            </div>
                             <div className="mb-3 mt-3">
                                    <textarea type="text" rows= '3' className="form-control" id="home address" name="home address" placeholder="Reason for Cancellation" required />
                                </div>
...
export default Hostelcancelform